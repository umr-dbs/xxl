...
/**
 * Tests if initial setting a special property will be correctly restored (see
 * createIndexedSetAndSave marker)
 * 
 * @author Marcus Pinnecke (pinnecke@mathematik.uni-marburg.de)
 * 
 */
public class IndexedSetSaveReloadRelationalTestBlockSize {
  ...
  final int MAX_ITEMS_TO_INSERT = 1000;
