 ...
 * <br/>
 * 
 * This class extends <tt>KeyRange</tt> for using <b>Doubles</b> as keys.<br/>
 * <br/>
 * 
 ...
 */
public class DoubleKeyRange extends KeyRange {

  /**
   * Used for a functional like programming style which creates in this case a new ranges.
   */
  public static Function<Object, DoubleKeyRange> FACTORY_FUNCTION =
      new AbstractFunction<Object, DoubleKeyRange>() {
        @Override
        public DoubleKeyRange invoke(Object argument0, Object argument1) {
          return new DoubleKeyRange((Double) argument0, (Double) argument1);
        }
      };
   ...
   * @see xxl.core.indexStructures.BPlusTree.KeyRange
   */
  public DoubleKeyRange(double min, double max) {
    super(min, max);
  }
  ...
  @Override
  public Object clone() {
    return new DoubleKeyRange(new Double((Double) this.sepValue), new Double(
        (Double) this.maxBound));
  }
}
