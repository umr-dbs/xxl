 ...
 * <br/>
 * 
 * This class extends <tt>Separator</tt> for using <b>Booleans</b>.<br/>
 * <br/>
 * 
 ...
 */
public class BooleanSeparator extends Separator {

  /**
   * Used for a functional like programming style which forces a hard copy in this case.
   */
  public static Function<Object, BooleanSeparator> FACTORY_FUNCTION =
      new AbstractFunction<Object, BooleanSeparator>() {

        @Override
        public BooleanSeparator invoke(Object argument) {
          return new BooleanSeparator((Boolean) argument);
        }
      };
   ...
   */
  public BooleanSeparator(boolean sepValue) {
    super(sepValue);
  }
  ...
  @Override
  public Object clone() {
    return new BooleanSeparator(new Boolean((Boolean) this.sepValue));
  }
