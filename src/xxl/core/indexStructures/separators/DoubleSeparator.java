 ...
 * <br/>
 * 
 * This class extends <tt>Separator</tt> for using <b>Doubles</b>.<br/>
 * <br/>
 * 
 ...
 */
public class DoubleSeparator extends Separator {

  /**
   * Used for a functional like programming style which forces a hard copy in this case.
   */
  public static Function<Object, DoubleSeparator> FACTORY_FUNCTION =
      new AbstractFunction<Object, DoubleSeparator>() {

        @Override
        public DoubleSeparator invoke(Object argument) {
          return new DoubleSeparator((Double) argument);
        }
      };
   ...
   */
  public DoubleSeparator(double sepValue) {
    super(sepValue);
  }
  ...
  @Override
  public Object clone() {
    return new DoubleSeparator(new Double((Double) this.sepValue));
  }
